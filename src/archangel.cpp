...
void print(const char *msg, bool keepHistory = false)
{
    if (keepHistory)
    {
        console(msg);
    ...
    {
        CONPRINTF(ConsoleString, (ConsoleString, "%s", _(msg)));
    }
}
...
{
    bool isEnableRequest = (strcmp(msg, "good night sweet prince") == 0);
    bool isDisableRequest = (strcmp(msg, "good morning") == 0);
